...
export default function ReportPopup({
  ...
  const selectedLabel = reportReasons.find(r => r.value === reason)?.label || "Choose a reason...";
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-xl shadow-2xl w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* BEAUTIFUL FRAMER MOTION DROPDOWN */}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-700">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2.5 text-gray-400 hover:text-white transition font-medium"
            >
              Cancel
            </button>
            <button
              ...
              className="px-8 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition font-medium flex items-center gap-2"
            >
