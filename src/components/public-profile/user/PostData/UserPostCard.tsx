...
const UserPostCard = ({
  ...
  return (
    <div className="rounded-2xl bg-gray-800/60 border border-gray-800/80 shadow-lg p-6 cursor-pointer hover:bg-white/5 transition-all duration-300">
      {/* Header */}
      ...
      >
        <SafeHTML
          ...
          className="text-gray-300 py-4 border-b border-gray-700/70 mb-4 "
        />
      </div>
