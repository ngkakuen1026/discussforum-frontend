...
import UserFollowingRow from "./UserFollowingRow";
  ...
  if (isLoading)
    return (
      <div className="text-center py-8 text-gray-400">
        Loading User Followings...
      </div>
    );

  if (userFollowings.length === 0)
    return (
      <div className="text-center py-8 text-gray-400">No Following found.</div>
    );
    ...
    <div className="">
      <table className="w-full min-w-full border border-gray-800">
        ...
        <tbody className="divide-y divide-gray-800">
          {userFollowings.map((userFollowing: UserFollowType) => (
            <UserFollowingRow
              key={userFollowing.following_user_id}
